...
class AdminPermissionsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncItems = ref.watch(adminPermissionsProvider);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text('Разрешения', style: TextStyle(fontSize: 24)),
              const Expanded(
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16),
                    child: Text('Показано 1 до 20 из 83 совпадений', style: TextStyle(color: Colors.grey)),
                  )),
              SizedBox(
                width: 200,
                child: TextField(
