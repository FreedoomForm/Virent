              ...
              children: [
                Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Text('Роли', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w400, color: Color(0xFF1B2A4E))),
                        SizedBox(width: 12),
                        Text('Показано 1 до 8 из 8 совпадений', style: TextStyle(fontSize: 11, color: Color(0xFF868686))),
                      ],
                    ),
