                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => showAdminFormDialog(context, title: 'Добавить клиента', fields: const [AdminField(key: 'name', label: 'Имя'), AdminField(key: 'phone', label: 'Телефон'), AdminField(key: 'email', label: 'Email')], onSubmit: (values) async { await ref.read(genericCreateAction)('/admin/customers', values, customersListProvider); }),
                        icon: const Icon(Icons.add, size: 14, color: Colors.white),
                        label: const Text('Добавить клиента', style: TextStyle(fontSize: 11, color: Colors.white)),
