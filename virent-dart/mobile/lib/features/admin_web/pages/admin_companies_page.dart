              ...
              children: [
                Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Text('Компании', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w400, color: adminTextDark)),
                        SizedBox(width: 12),
                        Text('Показано 1 до 7 из 7 совпадений', style: TextStyle(fontSize: 11, color: adminTextGray)),
                      ]),
