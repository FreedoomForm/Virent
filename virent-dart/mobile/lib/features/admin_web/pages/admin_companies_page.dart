...
class AdminCompaniesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncItems = ref.watch(adminCompaniesProvider);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              const Text('Companies', style: TextStyle(fontSize: 24)),
              const Expanded(
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16),
                    child: Text('Показано 1 до 7 из 7 совпадений', style: TextStyle(color: Colors.grey)),
                  )),
              SizedBox(
                width: 200,
                child: TextField(
