            ...
            child: Column(
              children: [
                ...
                Expanded(
                  child: ListView(
                    children: [
                      _contactRow(context, 'Ташкент', '+998712000373', 'virent2022@gmail.com', '@ViRent2023', '', 'https://virent.uz', '12'),
                    ],
                  ),
                ),
                const Divider(height: 1),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: Text(email, style: const TextStyle(fontSize: 11, color: adminPrimary))),
