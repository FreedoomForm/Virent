...
class AdminAgreementsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncItems = ref.watch(adminAgreementsProvider);
            ...
            children: [
              ...
              const Expanded(
                  child: Padding(
                    ...
                    child: Text('Показано 1 до 3 из 3 совпадений', style: TextStyle(color: Colors.grey)),
                  )),
              SizedBox(
                width: 200,
                child: TextField(
  ...
  DataRow _buildItemRow(Map<String, dynamic> item) {
    ...
    return DataRow(cells: [
      DataCell(Text(file)),
      DataCell(Text(urlLabel)),
      DataCell(Text(htmlFile)),
      DataCell(Row(
        children: [
