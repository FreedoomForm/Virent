                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => showAdminFormDialog(context, title: 'Добавить push-уведомление', fields: const [AdminField(key: 'title', label: 'Заголовок'), AdminField(key: 'body', label: 'Текст')], onSubmit: (values) async { await ref.read(genericCreateAction)('/admin/push-history', values, pushHistoryListProvider); }),
                        icon: const Icon(Icons.add, size: 14, color: Colors.white),
                        label: const Text('Добавить push-уведомление', style: TextStyle(fontSize: 11, color: Colors.white)),
