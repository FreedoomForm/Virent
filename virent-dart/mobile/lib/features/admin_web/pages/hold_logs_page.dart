                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => showAdminFormDialog(context, title: 'Добавить запись холда', fields: const [AdminField(key: 'client_id', label: 'ID клиента'), AdminField(key: 'amount', label: 'Сумма')], onSubmit: (values) async { await ref.read(genericCreateAction)('/admin/logs/hold', values, holdLogsProvider); }),
                        icon: const Icon(Icons.add, size: 14, color: Colors.white),
                        label: const Text('Добавить запись холда', style: TextStyle(fontSize: 11, color: Colors.white)),
