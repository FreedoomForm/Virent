              ...
              children: [
                Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Text('Цены', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w400, color: Color(0xFF1B2A4E))),
                        SizedBox(width: 12),
                        Text('Показано 1 до 9 из 9 совпадений', style: TextStyle(fontSize: 11, color: Color(0xFF868686))),
                      ],
                    ),
          ...
          SizedBox(
            ...
            child: Align(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF467FD0), borderRadius: BorderRadius.circular(3)),
