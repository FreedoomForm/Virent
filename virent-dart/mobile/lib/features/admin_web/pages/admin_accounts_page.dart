                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => showAdminFormDialog(context, title: 'Добавить админа', fields: const [AdminField(key: 'name', label: 'Имя'), AdminField(key: 'email', label: 'Email'), AdminField(key: 'password', label: 'Пароль')], onSubmit: (values) async { await ref.read(genericCreateAction)('/admin/create', values, adminListProvider); }),
