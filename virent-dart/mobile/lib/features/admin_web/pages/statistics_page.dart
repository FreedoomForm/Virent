      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ElevatedButton(
                onPressed: () => showAdminInfoDialog(context, 'Табличная выгрузка', 'Запущена выгрузка статистики в таблицу'),
          ...
          async.when(
            ...
            data: (stats) {
              ...
              return GridView.count(
                ...
                children: [
                  _buildStatCard('${_s('avg_ride_duration', '24.25 мин.')}', 'Средняя продолжительность поездки', const Color(0xFF4A81D4)),
                  _buildStatCard('${_s('active_clients', '1278')}', 'Количество клиентов ≥ 2 поездок', const Color(0xFF4FC1E9)),
                  _buildStatCard('${_s('revenue', '109984540.39 C.')}', 'Доход за период', const Color(0xFFFFCE54)),
                  _buildStatCard('${_s('rentals', '7979')}', 'Количество аренд за период', const Color(0xFFDA4453)),
                  _buildStatCard('${_s('inactive_rentals', '444')}', 'Количество неактивных аренд за период', const Color(0xFFFFCE54)),
                  _buildStatCard('${_s('avg_check', '13,784.25')}', 'Средний чек за период', const Color(0xFF4A81D4)),
                ],
              );
            },
          ),
                ...
                Row(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () => showAdminInfoDialog(context, 'Показать', 'Данные о доходе за период загружены'),
