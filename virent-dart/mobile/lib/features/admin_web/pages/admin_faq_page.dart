                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => showAdminFormDialog(context, title: 'Добавить вопрос FAQ', fields: const [AdminField(key: 'question', label: 'Вопрос'), AdminField(key: 'answer', label: 'Ответ')], onSubmit: (values) async { await ref.read(genericCreateAction)('/admin/faq', values, adminFaqProvider); }),
                        icon: const Icon(Icons.add, size: 14, color: Colors.white),
                        label: const Text('Добавить вопрос FAQ', style: TextStyle(fontSize: 11, color: Colors.white)),
