                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => showAdminFormDialog(context, title: 'Добавить геозону', fields: const [AdminField(key: 'name', label: 'Название'), AdminField(key: 'type', label: 'Тип'), AdminField(key: 'city_id', label: 'ID города')], onSubmit: (values) async { await ref.read(genericCreateAction)('/zones', values, zonesListProvider); }),
